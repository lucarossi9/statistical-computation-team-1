...
\begin{figure}[h]\centering
\includegraphics[scale=0.42]{sexgrades.png}\quad\includegraphics[scale=0.42]{distrib.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.42]{sexstudy.png}
\includegraphics[scale=0.42]{distrib2.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.42]{age.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.35]{famsize.png}\quad\includegraphics[scale=0.35]{distrib3.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.35]{pstatus.png}\quad\includegraphics[scale=0.35]{distrib4.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.4]{famrel.png}
