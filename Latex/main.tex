...
\begin{figure}[h]\centering
\includegraphics[scale=0.44]{hyp_test_G3_FvsM.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.44]{hyp_test_G1_FvsM.png}
\includegraphics[scale=0.44]{hyp_test_G2_FvsM.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.44]{hyp_test_MvsF_study_time.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.44]{hyp_test_study_time_2vs3.png}
\includegraphics[scale=0.44]{hyp_test_study_time_3vs4.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.45]{hyp_test_famsize.png}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.45]{hyp_test_Pstatus.png}
\caption{Test between student with big vs  small families.}
\end{figure}
...
\begin{figure}[h]\centering
\includegraphics[scale=0.5]{hyp_test_femrel.png}
