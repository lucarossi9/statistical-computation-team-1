...
\\In this project we want to study the data in order to see if we can credit our opinions or not and to try to predict grades knowing all the other variables. 
...
We decide to split our work in four different points, and for each point answer different question:
\begin{enumerate}
